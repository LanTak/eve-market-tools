 ...
 * @method     ChildGroupsQuery orderByPublished($order = Criteria::ASC) Order by the published column
 * @method     ChildGroupsQuery orderByCategoryId($order = Criteria::ASC) Order by the category_id column
 *
 ...
 * @method     ChildGroupsQuery groupByPublished() Group by the published column
 * @method     ChildGroupsQuery groupByCategoryId() Group by the category_id column
 *
 ...
 * @method     ChildGroups findOneByName(string $name) Return the first ChildGroups filtered by the name column
 * @method     ChildGroups findOneByPublished(int $published) Return the first ChildGroups filtered by the published column
 * @method     ChildGroups findOneByCategoryId(int $category_id) Return the first ChildGroups filtered by the category_id column *
 ...
 * @method     ChildGroups requireOneByPublished(int $published) Return the first ChildGroups filtered by the published column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildGroups requireOneByCategoryId(int $category_id) Return the first ChildGroups filtered by the category_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildGroups[]|ObjectCollection findByPublished(int $published) Return ChildGroups objects filtered by the published column
 * @method     ChildGroups[]|ObjectCollection findByCategoryId(int $category_id) Return ChildGroups objects filtered by the category_id column
...
abstract class GroupsQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT group_id, name, published, category_id FROM groups WHERE group_id = :p0';
        try {
    ...
    public function filterByPublished($published = null, $comparison = null)
    {
        if (is_array($published)) {
            ...
            if (isset($published['min'])) {
                $this->addUsingAlias(GroupsTableMap::COL_PUBLISHED, $published['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($published['max'])) {
                $this->addUsingAlias(GroupsTableMap::COL_PUBLISHED, $published['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GroupsTableMap::COL_PUBLISHED, $published, $comparison);
    }
    ...
    public function filterByCategoryId($categoryId = null, $comparison = null)
    {
        if (is_array($categoryId)) {
            ...
            if (isset($categoryId['min'])) {
                $this->addUsingAlias(GroupsTableMap::COL_CATEGORY_ID, $categoryId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($categoryId['max'])) {
                $this->addUsingAlias(GroupsTableMap::COL_CATEGORY_ID, $categoryId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GroupsTableMap::COL_CATEGORY_ID, $categoryId, $comparison);
    }
