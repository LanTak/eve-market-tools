...
abstract class Category implements ActiveRecordInterface
{
    ...
    public function setPublished($v)
    {
        ...
        if ($this->published !== $v) {
            $this->published = $v;
            $this->modifiedColumns[CategoryTableMap::COL_PUBLISHED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategoryTableMap::translateFieldName('Published', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_PUBLISHED)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_PUBLISHED)) {
            $criteria->add(CategoryTableMap::COL_PUBLISHED, $this->published);
        }
