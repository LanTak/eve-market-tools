...
class CategoryTableMap extends TableMap
{
     ...
     */
    const COL_PUBLISHED = 'category.published';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('CategoryId', 'Name', 'Published', ),
        self::TYPE_CAMELNAME     => array('categoryId', 'name', 'published', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_CATEGORY_ID, CategoryTableMap::COL_NAME, CategoryTableMap::COL_PUBLISHED, ),
        self::TYPE_FIELDNAME     => array('category_id', 'name', 'published', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('CategoryId' => 0, 'Name' => 1, 'Published' => 2, ),
        self::TYPE_CAMELNAME     => array('categoryId' => 0, 'name' => 1, 'published' => 2, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_CATEGORY_ID => 0, CategoryTableMap::COL_NAME => 1, CategoryTableMap::COL_PUBLISHED => 2, ),
        self::TYPE_FIELDNAME     => array('category_id' => 0, 'name' => 1, 'published' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryTableMap::COL_PUBLISHED);
        } else {
