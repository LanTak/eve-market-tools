...
class RegionsTableMap extends TableMap
{
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(RegionsTableMap::COL_REGION_ID) && $criteria->keyContainsValue(RegionsTableMap::COL_REGION_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.RegionsTableMap::COL_REGION_ID.')');
        }
