...
class TypesTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('TypeId', 'Name', 'Description', 'Published', 'GroupId', ),
        self::TYPE_CAMELNAME     => array('typeId', 'name', 'description', 'published', 'groupId', ),
        self::TYPE_COLNAME       => array(TypesTableMap::COL_TYPE_ID, TypesTableMap::COL_NAME, TypesTableMap::COL_DESCRIPTION, TypesTableMap::COL_PUBLISHED, TypesTableMap::COL_GROUP_ID, ),
        self::TYPE_FIELDNAME     => array('type_id', 'name', 'description', 'published', 'group_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('TypeId' => 0, 'Name' => 1, 'Description' => 2, 'Published' => 3, 'GroupId' => 4, ),
        self::TYPE_CAMELNAME     => array('typeId' => 0, 'name' => 1, 'description' => 2, 'published' => 3, 'groupId' => 4, ),
        self::TYPE_COLNAME       => array(TypesTableMap::COL_TYPE_ID => 0, TypesTableMap::COL_NAME => 1, TypesTableMap::COL_DESCRIPTION => 2, TypesTableMap::COL_PUBLISHED => 3, TypesTableMap::COL_GROUP_ID => 4, ),
        self::TYPE_FIELDNAME     => array('type_id' => 0, 'name' => 1, 'description' => 2, 'published' => 3, 'group_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('published', 'Published', 'VARCHAR', false, 6, null);
